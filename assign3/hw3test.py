# Unit tests for Programming Assignment 3, CMPS101 Winter16
    ...
    def test(self):
        for n in range(10,100,10):
            ...
            for i in range(1,n-4,2):
                ...
                self.assertEqual(A.get_next(),(i-1,i,float(n-i),0,0))
                self.assertEqual(H.get_next(),(i-1,i,float(n-i),0,0))
            ...
            self.assertEqual(A.get_next()[0:3],(-1,7,3.0))
            self.assertEqual(H.get_next()[0:3],(-1,7,3.0))

            #try for other wall
            A.insert(8,-1,1.0,0,0)
            H.insert(8,-1,1.0,0,0)
            self.assertEqual(A.get_next()[0:3],(8,-1,1.0))
            self.assertEqual(H.get_next()[0:3],(8,-1,1.0))
